...
//    public static final String REQUEST_URL = "http://test-check.qd-hongdao.haier.net/sql-check/parse/check";
    ...
    public static final String SQL_GROUP_BY_DESC = String.format("一个SQL内最多进行{}次分组，之后每增加一次，分数-{}",
    ...
    public static final String SQL_UNION_DESC = String.format("同一个SQL内最多进行{}次union，之后每增加一次，分数-{}",
    ...
    public static final String SQL_JOIN_DESC = String.format("一个SQL内join次数最多为{}次，之后每增加一次，分数-{}",
    ...
    public static final String SQL_ORDER_BY_DESC = String.format("一个SQL内最多进行{}次排序，之后每增加一次，分数-{}",
    ...
    public static final String SQL_LENGTH_DESC = String.format("SQL长度阈值为{}，之后长度每增加1000，分数-{}",
    ...
    public static final String SQL_TABLE_ERF_DESC = String.format("同一个SQL内表的引用个数最多为{}，之后长度每增加1，分数-{}",
    ...
    public static final String SQL_READ_TABLE_DESC = String.format("同一个SQL内表的使用次数最多为{}，之后每使用一次，分数-",
    ...
    public static final String SQL_SCAN_FILE_COUNT_DESC = String.format("一个SQL内最多扫描文件个数为{}，之后每增加一个,分数-{}",
    ...
    public static final String SQL_SCAN_FILE_SIZE_DESC = String.format("一个SQL内最多扫描文件大小为{}M，之后每增加100M,分数-{}",
    ...
    public static final double SQL_SCAN_LE10M_FILE_COUNT_SCORE = 0.2;
    public static final String SQL_SCAN_LE10M_FILE_COUNT_DESC = String.format("一个SQL内最多扫描{}个小文件（小于10M），之后每增加一个，分数-{}",
            SQL_SCAN_LE10M_FILE_COUNT_THRESHOLD, SQL_SCAN_LE10M_FILE_COUNT_SCORE);
    ...
    public static final String SQL_SCAN_PARTITION_COUNT_DESC = String.format("一个SQL内最多扫描的分区数量为{}，之后每增加一个，分数-{}",
