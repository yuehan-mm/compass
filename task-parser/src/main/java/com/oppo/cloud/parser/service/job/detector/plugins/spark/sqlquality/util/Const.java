...
//    public static final String REQUEST_URL = "http://test-check.qd-hongdao.haier.net/sql-check/parse/check";
    ...
    public static final String SQL_UNION_DESC = String.format("同一个SQL内最多进行%s次union，之后每增加一次，分数-%s",
    ...
    public static final String SQL_JOIN_DESC = String.format("一个SQL内join次数最多为%s次，之后每增加一次，分数-%s",
